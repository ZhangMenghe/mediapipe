...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.acu_main_activity);
  ...
  private void setupRecycleView(){
    recyclerView = (RecyclerView)findViewById(R.id.mask_recycle);
    ...
    recyclerViewAdapter = new maskRecyclerViewAdapter(this, recyclerView);
